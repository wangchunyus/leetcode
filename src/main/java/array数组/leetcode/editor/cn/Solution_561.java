...
// -10⁴ <= nums[i] <= 10⁴ 
// 
// Related Topics 贪心 数组 计数排序 排序 👍 302 👎 0
 ...
 *
 * @author wangcy
 * @since  2022-06-07 10:55:52
 **/

  public class Solution_561{
      public static void main(String[] args) {

          Solution solution = new Solution_561().new Solution();
          int[] a = {1,2,3,4};
          int i = solution.arrayPairSum(a);
...
class Solution {
    public int arrayPairSum(int[] nums) {
        ...
        while (point < nums.length-1){
               total = total + Math.min(nums[point],nums[point+1]);
               point += 2;
        }
        return total;
