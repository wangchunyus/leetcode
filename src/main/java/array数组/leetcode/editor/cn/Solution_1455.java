 ...
 *
 * @author wangcy
 * @since  2022-07-19 10:38:10
 **/

  public class Solution_1455{
      public static void main(String[] args) {

          Solution solution = new Solution_1455().new Solution();
          String sen = "i am tired";
          String sea = "you";
          int prefixOfWord = solution.isPrefixOfWord(sen, sea);
...
class Solution {
    public int isPrefixOfWord(String sentence, String searchWord) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            String sub = split[i].substring(0, length);
