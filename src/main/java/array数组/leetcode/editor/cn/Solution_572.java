...
// 
// 
// Related Topics 树 深度优先搜索 二叉树 字符串匹配 哈希函数 👍 749 👎 0
 ...
 *
 * @author wangcy
 * @since  2022-06-14 17:08:01
 **/

  public class Solution_572{
      public static void main(String[] args) {

          Solution solution = new Solution_572().new Solution();
          Integer[] tree1 = {3,4,5,1,2};
          Integer[] tree2 = {4,1,2};
          TreeNode build = TreeNodeUtil.build(tree1);
          TreeNode build1 = TreeNodeUtil.build(tree2);
          boolean subtree = solution.isSubtree(build, build1);
