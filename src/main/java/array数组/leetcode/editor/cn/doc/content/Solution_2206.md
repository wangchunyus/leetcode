...
<b>输出：</b>true
<b>解释：</b>
nums<span><code>&nbsp;中总共有 6 个元素，所以它们应该被划分成</code></span> 6 / 2 = 3 个数对。
...
<div><div>Related Topics</div><div><li>位运算</li><li>数组</li><li>哈希表</li><li>计数</li></div></div><br><div><li>👍 12</li><li>👎 0</li></div>