 ...
 *
 * @author wangcy
 * @since 2022-06-10 16:44:32
 **/

public class Solution_160 {
    public static void main(String[] args) {

        Solution solution = new Solution_160().new Solution();
        int[] A = {4,1,8,4,5};
        int[] B = {5,6,1,8,4,5};
        ListNode builderA = ListNodeUtil.builder(A);
        ListNode builderB = ListNodeUtil.builder(B);
        ListNode intersectionNode = solution.getIntersectionNode(builderA, builderB);
    }
